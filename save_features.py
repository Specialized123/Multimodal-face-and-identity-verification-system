...
predictor = dlib.shape_predictor('F:/AI Study/FaceRecognition-main/FaceRecognition-main/data/dlib/shape_predictor_68_face_landmarks.dat')
...
while cap.isOpened():
    ...
    # if k == 27:
    #     filename = "F:/AI Study/FaceRecognition-main/FaceRecognition-main/data/user_pic/{}.jpg".format(user)
